<div ng-controller="PopoverDemoCtrl">
    ...
    <div class="form-group">
      ...
      <input type="text" ng-model="dynamicPopover.content" class="">
    </div>
    <div class="form-group">
      <label>Popup Title:</label>
      <input type="text" ng-model="dynamicPopover.title" class="">
    </div>
    <div class="form-group">
      <label>Popup Template:</label>
      <input type="text" ng-model="dynamicPopover.templateUrl" class="">
    </div>
    ...
    <div class="form-group">
      ...
      <select class="" ng-model="placement.selected" ng-options="o as o for o in placement.options"></select>
    </div>
    ...
    <input type="text" value="Click me!" uib-popover="I appeared on focus! Click away and I'll vanish..."  popover-trigger="focus" class="">
