<div ng-controller="TooltipDemoCtrl">
    ...
    <div class="form-group">
      ...
      <input type="text" ng-model="dynamicTooltipText" class="">
    </div>
    <div class="form-group">
      <label>Dynamic Tooltip Popup Text</label>
      <input type="text" ng-model="dynamicTooltip" class="">
    </div>
    <p>
    ...
    <div class="form-group">
      ...
      <input type="text" value="Click me!" uib-tooltip="See? Now click away..." tooltip-trigger="focus" tooltip-placement="right" class="" />
    </div>

    <div class="form-group" ng-class="{'has-error' : !inputModel}">
      <label>Disable tooltips conditionally:</label>
      <input type="text" ng-model="inputModel" class=""
